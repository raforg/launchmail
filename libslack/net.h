...
__START_DECLS
int net_server __PROTO ((const char *interface, const char *service, port_t port, sockaddr *addr, size_t *addrsize));
int net_client __PROTO ((const char *host, const char *service, port_t port, sockaddr *addr, size_t *addrsize));
int net_udp_server __PROTO ((const char *interface, const char *service, port_t port, sockaddr *addr, size_t *addrsize));
int net_udp_client __PROTO ((const char *host, const char *service, port_t port, sockaddr *addr, size_t *addrsize));
int net_create_server __PROTO ((const char *interface, const char *service, port_t port, int type, int protocol, sockaddr *addr, size_t *addrsize));
int net_create_client __PROTO ((const char *host, const char *service, port_t port, int type, int protocol, sockaddr *addr, size_t *addrsize));
...
ssize_t net_send __PROTO ((int sockfd, size_t timeout, const char *fmt, ...));
ssize_t net_vsend __PROTO ((int sockfd, size_t timeout, const char *fmt, va_list args));
