...
# Uncomment this if your system doesn't have strcasecmp() and strncasecmp().
#
...
SLACK_MODULES := daemon err fio $(GETOPT) hsort lim list log map mem msg net opt prog prop sig $(SNPRINTF) str thread $(VSSCANF)
...
# Uncomment this on Solaris for sockets (used by daemon anad net modules)
#
# SLACK_LIBS += xnet
